...
<head>
  ...
  <title>@yield('pagetitle') - eShopper</title>
  <!-- General CSS Files -->
      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white"> <img alt="image" src="{{ asset('dashboard_asset/assets/img/users/user-1.png') }}" class="rounded-circle">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="{{ asset('dashboard_asset/assets/img/user.png') }}"
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="{{ asset('dashboard_asset/assets/img/logo.png') }}" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('admin.createcategory') }}">Create Category</a></li>
                <li><a class="nav-link" href="{{ route('admin.allcategory') }}">All Category</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="{{ route('admin.allsubcategory') }}">All Sub Category</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Brands</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('admin.createbrands') }}">Create Brand</a></li>
                <li><a class="nav-link" href="{{ route('admin.allbrands') }}">All Brands</a></li>
              </ul>
            </li>
            <li class="menu-header">Products Section</li>
            <li><a class="nav-link" href="{{ route('admin.addproduct') }}"><i data-feather="file"></i><span>Add Product</span></a></li>
            <li><a class="nav-link" href="{{ route('admin.allproducts') }}"><i data-feather="file"></i><span>All Products</span></a></li>
            <li class="menu-header">Others Section</li>
            <li><a class="nav-link" href="{{ route('admin.message') }}"><i data-feather="file"></i><span>Messages</span></a></li>
          </ul>
        </aside>
      </div>
      <!-- Main Content -->
